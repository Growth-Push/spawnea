#!/usr/bin/env sh
# ==============================================================================
# Spawnea - Universal POSIX Lifecycle Event Hook
#
# Standard shell utility to log lifecycle events from any CLI tool or wrapper.
# Usage:
#   spawnea-hook.sh <event_type> [optional_json_payload]
# ==============================================================================
...
if [ -d "${BASE_DIR}" ]; then
  printf '{"sessionId":"%s","harness":"generic","eventType":"%s","timestamp":"%s"}\n' \
